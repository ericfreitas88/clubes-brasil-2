...
$tpl = new Template("/xampp/htdocs/clubes-brasil-2/management/user-management/template/perfil_password_management.html");
...
if (!mysqli_affected_rows($conexao)) {
  ...
  header('location: /clubes-brasil-2/management/user-management/perfil_management.php');
  exit;
}
